...
class CamemBERTEmbed(nn.Module):
    ...
    def forward(self, features):
        ...
        output_tokens = self.camembert(input_ids=input_ids.view(-1, 131), token_type_ids=None,
                                       attention_mask=attention_mask.view(-1, 131))[0]
    ...
    def get_sentence_features(self, tokens: List[int], pad_seq_length: int):
        ...
        return {'input_ids': torch.tensor([np.asarray(input_ids, dtype=np.int64)]),
